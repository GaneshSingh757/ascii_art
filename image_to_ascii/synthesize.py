...
IMAGES = [
    'wallpaperuse.com-outrun-wallpaper-76592.png',
...
def get_image():
    ...
    # open image
    with resources.open_binary(photos, IMAGES[n]) as fp:
        img = fp.read()
...
class Drive:
    def __init__(self):
        # open font resource
        with resources.open_binary('image_to_ascii', 'RobotoMono-VariableFont_wght.ttf') as fp:
            font = fp.read()
        # initialize font
